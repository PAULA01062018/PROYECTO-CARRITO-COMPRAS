...
class CompraProductoTienda {
     ...
     datoCodigoProducto(datosProductos){
          ...
          do {
               ...
               if (sw){
                    console.log("el codigo que digito no existe en el inventario");
               }
          } while (sw);
     ...
     datoCantidadProducto (datosProductos){
          ...
          do {
               valor = validacionNumero("Digite Número de unidades que desea comprar ==>");

               if (valor <= this.getCantidadCompra){
                    this.setCantidadCompra = valor;
                    try {
                         datosProductos.forEach((objeto, index) => {
                              if (objeto.getNombreProducto === this.getProductoCompra && valor >0){
                    ...
                    console.log ("por el momento no tenemos esas unidades en venta");
               };
          } while (sw);
...
//solicitamos el nombre del cliente y lo validamos
